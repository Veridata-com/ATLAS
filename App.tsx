  ...
  const initializeApp = async () => {
    try {
      ...
      if (isSupabaseConfigured()) {
        ...
        if (!syncSuccess) {
          console.warn('Failed to sync from Supabase, but app will continue with cached data');
        }
      } else {
        console.warn('Supabase not configured. Please set SUPABASE_URL and SUPABASE_ANON_KEY in supabaseService.ts');
